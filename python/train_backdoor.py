...
def get_args_parser():
    ...
    parser.add_argument('--data-set', default='IMNET', 
                        choices=['CIFAR10', 'CIFAR100', 'GTSRB', 'CELEBATTR', 'T-IMNET', 'IMNET', 'INAT', 'INAT19', 'IMAGEWOOF', 'PubFig', 'PubFig50', 'CIFAR10LT', 'STL10', 'SVHN', 'FOOD101', 'FLOWERS102', 'OXFORDPET'],
...
def create_model(args):
    ...
    if args.model.startswith('my'):
        ...
        elif args.model == 'myresnet34':
            from models.resnet import ResNet34
            model = ResNet34(num_classes=args.nb_classes, input_size=args.input_size)
    else:
        if 'vit' in args.model or 'deit' in args.model:
            ...
            # EfficientNet family: efficientnet_b0 ~ efficientnet_b7, efficientnet_v2_s/m/l
            model = timm.models.create_model(
                args.model,
                pretrained=args.pretrained,
                num_classes=args.nb_classes,
            ...
            # MobileNet family: mobilenetv2_100, mobilenetv3_large_100, etc.
            model = timm.models.create_model(
                args.model,
                pretrained=args.pretrained,
                num_classes=args.nb_classes,
            ...
            # Swin Transformer family: swin_tiny_patch4_window7_224, swin_small_*, swin_base_*
            model = timm.models.create_model(
                args.model,
                img_size=args.input_size,
                pretrained=args.pretrained,
            ...
            # RegNet family: regnety_002, regnety_004, regnety_008, regnety_016, regnety_032, etc.
            model = timm.models.create_model(
                args.model,
                pretrained=args.pretrained,
                num_classes=args.nb_classes,
...
def main(args):
    ...
    class_dict = {'CIFAR10': 10, 'GTSRB': 43, 'T-IMNET': 200, 'CIFAR100': 100, 'CELEBATTR': 8, 'IMAGEWOOF': 10, 'PubFig': 150, 'PubFig50': 50, 'CIFAR10LT': 10, 'STL10': 10, 'SVHN': 10, 'FOOD101': 101, 'FLOWERS102': 102, 'OXFORDPET': 37}
    ...
    if args.data_set == 'CIFAR10' or args.data_set == 'CIFAR10LT':
        ...
        label_list = torch.tensor(dset.labels.tolist())
    elif args.data_set == 'SVHN':
        label_list = torch.tensor(dset.labels)
    elif args.data_set in ('FOOD101', 'FLOWERS102', 'OXFORDPET'):
        label_list = torch.tensor(dset.targets)
    else:
        label_list = None
    ...
    if args.selection_strategy == 'knn' and args.attack_mode == 'clean_label':
        ...
        file_path = f'resources/{args.selection_strategy}_{args.surrogate_model}_{args.data_set}_{args.attack_label}_fa5.pth'
        ...
        file_path = f'resources/{args.selection_strategy}_{args.surrogate_model}_{args.data_set}_{args.attack_label}.pth'
        score_dict = torch.load(file_path)
