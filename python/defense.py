...
def parse_args():
    """Parse CLI arguments for backdoor defense evaluation.

    Returns:
        argparse.Namespace: Parsed arguments including model path, dataset, and defense-specific hyperparameters.
    """
    ...
    parser.add_argument('--data-path', default='./data', type=str,
                        help='dataset path')
    parser.add_argument('--data-set', default='GTSRB',
    ...
    parser.add_argument('--attack_label', default=1, type=int)
    ...
    parser.add_argument('--strip_detection_boundary', default=0.2, type=float, help='Detection boundary')
...
if __name__ == '__main__':
    args = parse_args()
    args.selection_strategy = args.strategy
    args.percentile = -1
