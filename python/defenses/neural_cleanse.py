...
def train(args, init_mask, init_pattern):
    dataset_val, _ = build_backdoor_dataset(0, args=args, is_train=False)                                                                           
...
def neural_cleanse(args):
    """Neural Cleanse: optimize reverse-engineered triggers per class and detect anomalous small norms."""
